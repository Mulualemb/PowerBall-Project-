#this page not active, will be replaced by Fmess i fix it
...
# # the lists first 5 numbers are sorted, and with a different color scheme than the last index in the list
...
#
# #if the user want to play, he must enter "y" into the input, anything else will end the program.
...
# print("you found", findme(firstlist, secondlist), "white ball/s\nand", findmetwo(firstlist, secondlist), "purple ball")
#
#
#
